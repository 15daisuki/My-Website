...
$$
を得た。\
更に、得られた風速をMass Flow Controllerという機械を用いて、多点風速計校正プログラムというソフトに入力した。各測定点において一分間の平均電圧(16点)を取得し、風速と電圧の対応関係を求めた。その結果、精度の高い校正曲線を作成した。
...
### 実験前に風速計の動作確認
風速計(1~16番)を板に順番に取り付け、板から垂直距離を60mmに設定した。その後、板をターンテーブルに設置した。
